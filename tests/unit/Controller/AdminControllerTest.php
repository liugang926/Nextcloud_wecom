...
class AdminControllerTest extends TestCase {
    ...
    public function testSaveConfigSuccess() {
        $this->configService->expects($this->any())->method('setCorpId');
        $this->configService->expects($this->any())->method('setAgentId');
        $this->configService->expects($this->any())->method('setAppSecret');
